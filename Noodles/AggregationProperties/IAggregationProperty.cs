...
namespace Noodles.AggregationProperties
{
    ...
    {
        bool Test(IEnumerable<decimal> values, IMeanCalculator calculator, AggregationProperty.AggregationTestTypes method = AggregationProperty.AggregationTestTypes.Default);
